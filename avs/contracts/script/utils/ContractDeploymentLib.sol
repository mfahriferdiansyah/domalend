...
library ContractDeploymentLib {
    ...
    function deployContracts(
        ...
        bytes memory upgradeCall =
            abi.encodeCall(ECDSAStakeRegistry.initialize, (result.serviceManager, 0, quorum));
        UpgradeableProxyLib.upgradeAndCall(result.stakeRegistry, stakeRegistryImpl, upgradeCall);
        UpgradeableProxyLib.upgrade(result.serviceManager, serviceManagerImpl);
    ...
    function readDeploymentJson(
        ...
        data.serviceManager = json.readAddress(".contracts.serviceManager");
    ...
    function writeDeploymentJson(
        ...
        writeDeploymentJson("deployments/contracts/", block.chainid, data);
    }
