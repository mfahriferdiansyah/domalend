      ...
      <div className="space-y-6">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="rounded-lg bg-white shadow h-32 p-6 text-center flex flex-col justify-center">
              <p className="text-2xl font-bold text-black">{domain.totalLoansCreated}</p>
              <p className="text-sm font-medium text-black">Total Loans</p>
            </div>

            <div className="rounded-lg bg-white shadow h-32 p-6 text-center flex flex-col justify-center">
              <p className="text-2xl font-bold text-black">${formatUSDC(domain.totalLoanVolume || '0')}</p>
              <p className="text-sm font-medium text-black">Loan Volume</p>
            </div>

            <div className="rounded-lg bg-white shadow h-32 p-6 text-center flex flex-col justify-center">
              <p className="text-2xl font-bold text-black">{domain.totalScoringRequests}</p>
              <p className="text-sm font-medium text-black">Scores</p>
            </div>
          </div>
            ...
            <TabsContent value="overview" className="space-y-4">
              <div className="bg-white shadow rounded-lg p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="text-sm font-medium text-gray-500">Latest Score</label>
                    <div className="text-lg font-semibold">
                        ...
                        <div key={`${loan.loanId}-${index}`} className="border rounded-lg p-4">
                          ...
                          <div className="grid grid-cols-2 gap-4 text-sm">
                            <div>
                              ...
                              <div className="font-semibold">${formatUSDC(loan.loanAmount || '0')}</div>
                            </div>
                            <div>
                        ...
                        <div key={auction.auctionId} className="border rounded-lg p-4">
                          ...
                          <div className="grid grid-cols-2 gap-4 text-sm">
                            <div>
                              ...
                              <div className="font-semibold">${formatUSDC(auction.finalPrice || '0')}</div>
                            </div>
                            <div>
              ...
              <div className="bg-white shadow rounded-lg p-6">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="text-lg font-semibold">{domain.totalScoringRequests} scores</div>
                  </div>
                </div>
              </div>
            </TabsContent>
